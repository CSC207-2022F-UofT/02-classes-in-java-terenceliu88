...
public class Silly implements Comparable<Silly>{
     ...
     *
     * @param x a string that represents the first part of the name
     * @param y a string that represents the second part of the name
     */
    public Silly(String x, String y) { this.name = x + y; }
